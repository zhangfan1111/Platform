...
// MenuConstructors.video = Video;  // 取消视频url上传
...
UploadImg.prototype = {
    ...
    insertLinkImg: function insertLinkImg(link) {
        ...
        img.onload = function () {
            img = null;
            // 设置插入图片的百分比
            editor.cmd.do('insertHTML', '<img src="' + link + '" style="width:30%;max-width:50%;max-height:50%;"/>');
        };
    ...
    uploadImg: function uploadImg(files) {
        ...
        arrForEach(resultFiles, function (file) {
            ...
            formdata.append("file", file);  // 修改上传图片参数为file
        });
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    if (result.errno != '0') {
                       ...
                       /* 
                        *   由于没有实现多文件上传，所以采用上面的方式上传 by 何昆林 2017.6.10
