var
	...
	devFile = "dist/jteddy.js",
	minFile = "dist/jteddy.min.js",
	mapFile = "dist/jteddy.min.map",

	releaseFiles = {
		"jteddy-VER.js": devFile,
		"jteddy-VER.min.js": minFile,
		"jteddy-VER.min.map": mapFile
	},

	googleFilesCDN = [
		"jteddy.js", "jteddy.min.js", "jteddy.min.map"
	],

	msFilesCDN = [
		"jteddy-VER.js", "jteddy-VER.min.js", "jteddy-VER.min.map"
	];
...
function makeReleaseCopies( Release ) {
	...
	Object.keys( releaseFiles ).forEach(function( key ) {
		...
		if ( /\.map$/.test( releaseFile ) ) {
			...
			// "file":"jteddy.min.js","sources":["jteddy.js"]
	...
	function makeArchive( cdn, files, callback ) {
		...
		var sum,
			...
			output = fs.createWriteStream(
				cdnFolder + "/" + cdn + "-jteddy-" + Release.newVersion + ".zip"
			),
			rver = /VER/;
