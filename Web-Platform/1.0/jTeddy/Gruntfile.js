module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		"compare_size": {
			files: [ "dist/jteddy.js", "dist/jteddy.min.js" ],
			options: {
				compress: {
...
//			test: [ "test/data/testrunner.js" ],
		...
		uglify: {
			all: {
				files: {
					"dist/jteddy.min.js": [ "dist/jteddy.js" ]
				},
				options: {
					preserveComments: false,
					sourceMap: true,
					sourceMapName: "dist/jteddy.min.map",
					report: "min",
					beautify: {
						"ascii_only": true
					},
					banner: "/*! jTeddy v<%= pkg.version %> | " +
						"(c) jTeddy Foundation | jteddy.org/license */",
					compress: {
						"hoist_funs": false,
						loops: false,
						unused: false
	...
	// Integrate jTeddy specific tasks
