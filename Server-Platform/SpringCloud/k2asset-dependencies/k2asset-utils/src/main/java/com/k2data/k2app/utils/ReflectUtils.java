...
public class ReflectUtils {
    ...
    public static Object invokeMethod(final Object object, final Method method, final Object ... args) {
        ...
        } catch (IllegalArgumentException | InvocationTargetException | IllegalAccessException iae) {
            throw new K2Exception(iae);
        }
    }
...
//            logger.warn("Class " + clazz + " doesn't have method " + methodName);
//        }
