...
public interface CommandValueOperation {
	 ...
	 * 
	 * <p>如果某个给定 key 已经存在，那么 MSET 会用新值覆盖原来的旧值，</p>
	 * <p>如果这不是你所希望的效果，请考虑使用 MSETNX 命令：它只会在所有给定 key 都不存在的情况下进行设置操作。</p>
	 * 
	 ...
	 * 
	 * <p>位的设置或清除取决于 value 参数，可以是 0-false 也可以是 1-true</p>
