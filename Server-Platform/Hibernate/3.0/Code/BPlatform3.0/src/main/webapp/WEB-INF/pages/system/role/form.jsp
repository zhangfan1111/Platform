...
<script type="text/javascript">
	var submitForm = function($dialog, $grid, $pjq) {
		if ($('form').form('validate')) {
			var url;
			url = system.contextPath + '/system/systemRoleController/save';
	...
	$(function() {
		if ($(':input[name="id"]').val().length > 0) {
			...
			$.post(system.contextPath + '/system/systemRoleController/getById/${id[0]}', {
	...
	<form method="post" class="form">
		...
		<fieldset>
			<table class="table" style="width: 100%;">
				...
				<tr>
					<td>英文名称</td>
					<td><input name="enName" class="easyui-textbox" data-options="required:false,height:30" style="width: 155px;" value="" /></td>
					<td>父角色</td>
					<td>
						<select id="parentId" name="parentId"  class="easyui-combotree" 
								data-options="url:'${app}/system/systemRoleController/treeGrid',
												idField:'id',
												textField:'name',
