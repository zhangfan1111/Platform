...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#selectX").combobox({
	        url: system.contextPath + '/system/systemDictController/getByCode/10.2.9/',
	        valueField: "code",
	        textField: "name",
	        panelHeight: "auto",
	        editable: false,
	        onSelect: function(rec){
	        	reCode = rec.code;
	        	reparamater = rec.remark;
	        	reload(system.contextPath + '/findByChart/'+reCode+"/",reType,reparamater);
	        },
	        onLoadSuccess: function(rec){
				//默认值
				$('#selectX').combobox('setValue', '10.2.9.2');
				reCode = '10.2.9.2';
				reparamater = rec[0].remark;
				reload(system.contextPath + '/findByChart/10.2.9.2/',reType,reparamater);
			}
	    });
		$("#graphics").combobox({
	        url: system.contextPath + '/system/systemDictController/getByCode/10.2.10/',
	        valueField: "code",
	        textField: "name",
	        panelHeight: "auto",
	        editable: false,
	        ...
	        onLoadSuccess: function(rec){
				//默认值
				$('#graphics').combobox('setValue', '10.2.10.1');
				reType = rec[0].enName;
				reload(system.contextPath + '/findByChart/'+reCode+'/',reType,reparamater);
			}
	    });
	...
	<div data-options="region:'north',border:false" style="height:40px">
		<table class="table">
			<tr>
				...
				<td>
					<input id="selectX" name="selectX" class="easyui-combobox"/>
				</td>
				<th>
					图形切换
				</th>
				<td>
					<input id="graphics" name="graphics" class="easyui-combobox"/>
				</td>
			</tr>
		</table>
	</div>
