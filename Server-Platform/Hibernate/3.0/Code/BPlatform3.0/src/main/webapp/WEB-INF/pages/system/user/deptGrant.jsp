...
<script type="text/javascript">
	var submitForm = function($dialog, $grid, $pjq) {
		...
		var po = {userId:'${userId[0]}',addDeptIds:addIds,delDeptIds:delIds};
		var params = $.param(po,true);
		$.post(system.contextPath + '/system/systemUserController/modifyDept?'+params, null, function(result) {
			if (result.success) {
	...
	$(function() {
		...
		$('#tree').tree({
			url : system.contextPath + '/system/systemUserController/loadUserDeptTree/',
			...
			onLoadSuccess : function(node, data) {
				/*$.post(system.contextPath + '/base/syresource!doNotNeedSecurity_getDeptResources.sy', {
					id : '${userId[0]}'
				}, function(result) {
					if (result) {
