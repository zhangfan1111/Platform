...
<script type="text/javascript">
	var resourceTreegrid,deptTree,currentDept;
	...
	$(function() {
		deptTree = $('#deptTree').tree({
			...
			onBeforeSelect : function(node) {
				var selNode = deptTree.tree('getSelected');
		...
		resourceTreegrid = $('#resourceTreegrid').treegrid({
			...
			onBeforeLoad : function(row, param) {
				param['master'] = 'SYSTEM_DEPT';
				if(currentDept) {
					param['masterValue'] = currentDept.id;
				}
				if(row) {
					param['id'] = row.id;
				}
...
<body>
    ...
    <div region="west" style="width: 200px;" title="部门">
        <ul id="deptTree"></ul>
    </div>
</body>
</html>